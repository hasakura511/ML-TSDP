...
def vol_adjsize_moc(debug, threadlist, skipcheck=False):
    ...
    marketList2 = [ ff[ff.CSIsym2==x].index[0] for x in marketList if x in ff.ix[updatedSymbols].CSIsym2.values]
    ...
    #overwritten later by betting_userselection
