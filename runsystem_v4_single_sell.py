...
pairs=['AUDUSD','NZDUSD','EURGBP','NZDCHF']
#pairs2=['AUDCHF','NZDCAD','USDCHF','USDCAD']
#pairs=['AUDUSD','NZDUSD','EURGBP','NZDCHF','AUDCHF','NZDCAD','USDCHF','USDCAD']
#pairsList=[pairs,pairs2]
