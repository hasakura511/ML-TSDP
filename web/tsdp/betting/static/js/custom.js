          ...
          var chart_title = '';
            ...
            if(tab_value==tab_value_index[2] + "K")
            {
                ...
                if(test==1)
                {
                    ...
                    var day5 = result.v4micro_ranking['2Day Lookback'];
                ...
                {
                	btn_click = 2;
                    var day5 = sortObject(result.v4micro_ranking['2Day Lookback']);
            ...
            else if(tab_value==tab_value_index[1] + "K")
            {
                ...
                if(test==1)
                {
                    ...
                    var day5 = result.v4mini_ranking['2Day Lookback'];
                ...
                {
                	btn_click = 2;
                    var day5 = sortObject(result.v4mini_ranking['2Day Lookback']);
            ...
            else if(tab_value==tab_value_index[0] + "K")
            {
                ...
                if(test==1)
                {
                    ...
                    var day5 = result.v4futures_ranking['2Day Lookback'];
                ...
                {
                	btn_click = 2;
                    var day5 = sortObject(result.v4futures_ranking['2Day Lookback']);
