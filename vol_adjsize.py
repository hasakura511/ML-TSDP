...
if lastDate > sigDate:
    ...
    voting9Cols=['Anti0.5LastSIG','AntiPrevACT','AntiSEA']
    ...
    voting13Cols = ['0.75LastSIG','AntiSEA','prevACT']
    voting14Cols = ['0.5LastSIG','prevACT','prevSEA']
    ...
    voting12Cols = ['1LastSIG','AntiPrevACT','AdjSEA']
    voting13Cols = ['0.75LastSIG','AntiSEA','prevACT']
    voting14Cols = ['0.5LastSIG','prevACT','LastSEA']
    voting15Cols = ['RiskOff','Anti0.75LastSIG','AntiSEA']
