...
\anaconda2\python proc_sig_adj.py consolidated>> \logs\daily_futures_orders.log
...
\anaconda2\python create_signalPlots.py 1 >> \logs\daily_other.log
\anaconda2\python heatmap_futuresCSI.py 1 >> \logs\daily_other.log
