...
bias = 'buyHold'
offline=False
pairs=['EURAUD','GBPUSD','GBPCAD','CADCHF']
...
bias = 'sellHold'
offline=False
pairs=['AUDUSD','NZDUSD','EURGBP','EURUSD','NZDCHF','AUDCHF','EURCAD','NZDCAD','USDCHF','EURCHF','USDCAD','AUDNZD','AUDCAD','AUDJPY','NZDJPY','CADJPY','CHFJPY','USDJPY','GBPJPY','EURJPY','EURNZD','GBPAUD','GBPNZD']
