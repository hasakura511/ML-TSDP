...
adj_size('USDJPY','100962390','STC', 1,'USDJPY','forex',True, 'SELL', 20000,'USD','JPY','IDEALPRO','CASH', False)
...
#adj_size('EURUSD','100961267','BTO', 1,'EURUSD','forex',True, 'SELL', 10000,'EUR','USD','IDEALPRO','CASH', False)
...
#adj_size('AUDUSD','100961267','BTO', 1,'AUDUSD','forex',True, 'SELL', 10000,'AUD','USD','IDEALPRO','CASH', False)
#adj_size('USDCAD','100961267','STC', 1,'USDCAD','forex',True, 'SELL', 10000,'USD','CAD','IDEALPRO','CASH', False)

#adj_size('AUDUSD','101008882','STC', 3,'AUDUSD','forex',True, 'SELL', 10000,'AUD','USD','IDEALPRO','CASH', False)
