...
adj_size(dps_model_pos, ib_pos,'EURJPY','100984342',"tXFaL4E6apdfmLtGasIovtGnUDXH_CQso7uBpOCUDYGVcm1w0w",1, 'EURJPY','forex',True, 10000,'EUR','JPY','IDEALPRO','CASH', False)
adj_size(dps_model_pos, ib_pos,'EURUSD','100984342',"tXFaL4E6apdfmLtGasIovtGnUDXH_CQso7uBpOCUDYGVcm1w0w",1, 'EURUSD','forex',True, 10000,'EUR','USD','IDEALPRO','CASH', False)
adj_size(dps_model_pos, ib_pos,'GBPUSD','100984342',"tXFaL4E6apdfmLtGasIovtGnUDXH_CQso7uBpOCUDYGVcm1w0w",1, 'GBPUSD','forex',True, 10000,'GBP','USD','IDEALPRO','CASH', False)
adj_size(dps_model_pos, ib_pos,'USDCHF','100984342',"tXFaL4E6apdfmLtGasIovtGnUDXH_CQso7uBpOCUDYGVcm1w0w",1, 'USDCHF','forex',True, 10000,'USD','CHF','IDEALPRO','CASH', False)
adj_size(dps_model_pos, ib_pos,'USDJPY','100984342',"tXFaL4E6apdfmLtGasIovtGnUDXH_CQso7uBpOCUDYGVcm1w0w",1, 'USDJPY','forex',True, 10000,'USD','JPY','IDEALPRO','CASH', False)
adj_size(dps_model_pos, ib_pos,'AUDUSD','100984342',"tXFaL4E6apdfmLtGasIovtGnUDXH_CQso7uBpOCUDYGVcm1w0w",1, 'AUDUSD','forex',True, 10000,'AUD','USD','IDEALPRO','CASH', False)
adj_size(dps_model_pos, ib_pos,'USDCAD','100984342',"tXFaL4E6apdfmLtGasIovtGnUDXH_CQso7uBpOCUDYGVcm1w0w",1, 'USDCAD','forex',True, 10000,'USD','CAD','IDEALPRO','CASH', False)
