...
proc_signal('EURUSD','100961267',1, 'EURUSD','forex',False, 10000,'EUR','USD','IDEALPRO','CASH', True)
proc_signal('GBPUSD','100961267',1, 'GBPUSD','forex',False, 10000,'GBP','USD','IDEALPRO','CASH', True)
proc_signal('USDCHF','100961267',1, 'USDCHF','forex',False, 10000,'USD','CHF','IDEALPRO','CASH', True)
proc_signal('USDJPY','100961267',2, 'USDJPY','forex',False, 20000,'USD','JPY','IDEALPRO','CASH', True)
proc_signal('AUDUSD','100961267',1, 'AUDUSD','forex',False, 10000,'AUD','USD','IDEALPRO','CASH', True)
proc_signal('USDCAD','100961267',1, 'USDCAD','forex',False, 10000,'USD','CAD','IDEALPRO','CASH', True)
...
#proc_signal('USDJPY','100961267',2, 'USDJPY','forex',True, 20000,'USD','JPY','IDEALPRO','CASH', False)
