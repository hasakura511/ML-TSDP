...
def gen_eq_rank(systems, recent, html, type='paper'):
    ...
    html = html + '<td>C2 Profit</td>'
    html = html + '<td>C2 Pure Profit</td>'
    html = html + '<td>C2 Mark to Market</td>'
    html = html + '<td>C2 Pure Mark to Market</td>'
    html = html + '<td>C2 Start Date</td>'
    html = html + '<td>C2 End Date</td>'
    html = html + '<td>IB Profit</td>'
    html = html + '<td>IB Pure Profit</td>'
    html = html + '<td>IB Mark to Market</td>'
    html = html + '<td>IB Pure Mark to Market</td>'
    html = html + '<td>IB Start Date</td>'
    html = html + '<td>IB End Date</td>'
    html = html + '</tr>'
